...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    <ul class="nav navbar-nav">
      <li><a href='myReservations.jsp'>Active Reservations</a></li>
      <li class="active"><a href='pastReservations.jsp'>Past Reservations</a></li>
    </ul>
  </div>
</nav>
</div>
...
Statement st = con.createStatement();
	...
	out.print("<b>Reservation #&nbsp&nbsp&nbsp&nbsp</b>");
	out.print("</td>");
	
	//make a column
	out.print("<td>");
	out.print("<b>Train ID Name&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</b>");
	out.print("</td>");
	
	out.print("<td>");
	out.print("<b>Transit Line &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</b>");
	out.print("</td>");
	
	out.print("<td>");
	out.print("<b>Origin &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</b>");
	out.print("</td>");

	
	//make a column
	out.print("<td>");
	out.print("<b>Destination&nbsp;&nbsp;&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</b>");
	out.print("</td>");
	
	out.print("<td>");
	out.print("<b>Departure time &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</b>");
	out.print("</td>");
	...
	*/
	out.print("<td>");
	out.print("<b>Fare ($) &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</b>");
	out.print("</td>");
